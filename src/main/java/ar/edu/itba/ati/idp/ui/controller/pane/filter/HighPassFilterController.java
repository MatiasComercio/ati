...
public class HighPassFilterController extends VBox {
  private static final Logger LOGGER = LoggerFactory.getLogger(HighPassFilterController.class);
  private static final String LAYOUT_PATH = "ui/pane/filter/highPassFilterPane.fxml";
  private static final String STAGE_TITLE = "High Pass Filter";
  ...
  public HighPassFilterController() {
  ...
  public void handleApply() {
    ...
    workspace.applyToImage(Filter.newInstance(HighPassMask.newInstance(width, height)));
  }
