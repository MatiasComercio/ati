...
public class MediaFilterController extends VBox {
  private static final Logger LOGGER = LoggerFactory.getLogger(MediaFilterController.class);
  private static final String LAYOUT_PATH = "ui/pane/filter/mediaFilterPane.fxml";
  private static final String STAGE_TITLE = "Media Filter";
  ...
  public void handleApply() {
    ...
    workspace.applyToImage(Filter.newInstance(MediaMask.newInstance(width, height)));
  }
