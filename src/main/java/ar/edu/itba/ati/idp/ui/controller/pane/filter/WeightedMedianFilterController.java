...
public class WeightedMedianFilterController extends VBox {
  private static final Logger LOGGER = LoggerFactory.getLogger(WeightedMedianFilterController.class);
  private static final String LAYOUT_PATH = "ui/pane/filter/weightedMedianFilterPane.fxml";
  private static final String STAGE_TITLE = "Weighted Median Filter";
  ...
  public WeightedMedianFilterController() {
  ...
  public void handleApply() {
    ...
    workspace.applyToImage(Filter.newInstance(WeightedMedianMask.newInstance(width, height)));
  }
